%Right eye simulation for 5*4 grid for Video S10
%Screen stimutulus defined in Lightmodelsimplewithfeedback.m
tic
%centre lens position and normal
lenspos =[ 220 0 0; 220 0 0 ;220 0 0;220 0 0; 220 0 0;220 0 0; 220 0 0];%um
...
MU =MU';
MU = [-1 0; 0 1]*MU';%Mirroring for rigt eye
...
modelparam.LightScale =500/0.002604;%Scale between photon absorbtions
modelparam.LightPreAdaption =30000;% Light pre-adaptation for current bump
    ...
    for j =0:3
            %Lens array position
             ...
             Data.(ci).dlensx =j;
              ...
              %Absorbtion outputs
             Data.(ci).light_series = zeros(1200,7);
...
save('vid1_r_50degs_5cm_single_dot.mat')
toc