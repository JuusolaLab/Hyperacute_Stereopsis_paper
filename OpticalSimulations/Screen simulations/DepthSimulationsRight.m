%Right eye simulation for depth analysis (fig. S54-55): 2 ommatidiums
%Used also in fig.5 to simulate one ommatidium in right eye
...
% hold off;
 ...
 save('fig5_double_r_50degs_-1.mat')
toc